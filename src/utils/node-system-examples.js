...
import {getAvailableSystemNodes} from './system-node-utils.js';
...
export const COMMON_NODE_SETS = {
    ...
    BEGINNER: ['on_start', 'print', 'add', 'subtract', 'equals', 'if', 'sequence'],

    // Math and logic nodes
    MATH: ['add', 'subtract', 'multiply', 'divide', 'pow', 'sqrt', 'abs', 'equals', 'greater_than', 'less_than', 'and', 'or', 'not'],
    ...
    UTILITIES: ['print', 'var_dump', 'delay', 'random', 'timestamp', 'read_file', 'write_file', 'http_get', 'parse_json'],

    // Flow control nodes
    FLOW_CONTROL: ['if', 'for', 'while', 'sequence', 'gate', 'do_once', 'multigate'],

    // Data manipulation nodes
    DATA: ['to_int', 'to_float', 'to_string', 'to_bool', 'array_push', 'array_pop', 'array_get', 'array_set', 'concat', 'substring', 'upper', 'lower']
};
