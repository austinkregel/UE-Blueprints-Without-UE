...
export function addSequenceNode(position = { x: 200, y: 200 }) { return addExecFlowNode('sequence', position); }
export function addBranchNode(position = { x: 200, y: 200 }) { return addExecFlowNode('branch', position); }
export function addGateNode(position = { x: 200, y: 200 }) { return addExecFlowNode('gate', position); }
export function addMultigateNode(position = { x: 200, y: 200 }) { return addExecFlowNode('multigate', position); }
export function addDoOnceNode(position = { x: 200, y: 200 }) { return addExecFlowNode('do_once', position); }
export function addDoNNode(position = { x: 200, y: 200 }) { return addExecFlowNode('do_n', position); }
export function addDelayNode(position = { x: 200, y: 200 }) { return addExecFlowNode('delay', position); }
export function addFlipFlopNode(position = { x: 200, y: 200 }) { return addExecFlowNode('flip_flop', position); }
export function addForLoopNode(position = { x: 200, y: 200 }) { return addExecFlowNode('for_loop', position); }
export function addForEachLoopNode(position = { x: 200, y: 200 }) { return addExecFlowNode('for_each_loop', position); }
export function addWhileLoopNode(position = { x: 200, y: 200 }) { return addExecFlowNode('while_loop', position); }
