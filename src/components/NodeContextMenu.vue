<template>
    ...
    >
        <div class="py-2">
            <!-- Node Info Header -->
            <div class="border-b border-zinc-200 px-3 py-2 dark:border-zinc-600">
                <div class="text-sm font-semibold text-zinc-900 dark:text-white">{{ node?.name || `Node ${node?.id}` }}</div>
                <div class="text-xs text-zinc-500 dark:text-zinc-400">{{ node?.nodeDefId || node?.type }}</div>
            </div>

            <!-- Node Actions -->
            <div class="px-3 py-1 text-xs font-semibold text-zinc-500 uppercase dark:text-zinc-400">Actions</div>
            ...
            <!-- Execution Actions -->
            <div class="px-3 py-1 text-xs font-semibold text-blue-600 uppercase dark:text-blue-400">Execution</div>

            <button
                v-if="canBeEntryPoint"
                class="flex w-full items-center px-3 py-2 text-left text-sm text-blue-700 hover:bg-zinc-100 dark:text-white dark:hover:bg-zinc-700"
            ...
            <button
                ...
                class="flex w-full items-center px-3 py-2 text-left text-sm text-green-700 hover:bg-zinc-100 dark:text-green-300 dark:hover:bg-zinc-700"
            ...
            <!-- Dangerous Actions -->
            <div class="px-3 py-1 text-xs font-semibold text-red-600 uppercase dark:text-red-400">Danger Zone</div>

            <button
                class="flex w-full items-center px-3 py-2 text-left text-sm text-orange-700 hover:bg-zinc-100 dark:text-orange-300 dark:hover:bg-zinc-700"
            ...
            <button
                class="flex w-full items-center px-3 py-2 text-left text-sm text-red-700 hover:bg-red-100 dark:text-red-300 dark:hover:bg-red-700"
